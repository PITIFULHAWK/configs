...
source ~/.aliases
alias winhome="cd && cd ../../mnt/c/C\ Drive"
alias c="nvim"
alias phynovate="cd ~/Shivam_Projects/phynovate/"
alias nd="npm run dev"
alias bn="bun run dev"
alias yn="yarn run dev"
...
alias ltree='eza --tree --icons --group-directories-first'
...
fcd() {
    local dir
    dir=$(fd --type d --hidden --follow --exclude .git | fzf --preview 'exa --tree {}')
    if [ -n "$dir" ]; then
        cd "$dir"
    fi
}
...
# bun completions
[ -s "/home/shivam_sourav/.bun/_bun" ] && source "/home/shivam_sourav/.bun/_bun"
export PATH="$HOME/.bun/bin:$PATH"
export PATH=$PATH:/usr/local/go/bin

export PATH="$PATH:/home/shivam_sourav/Applications/android-studio/bin"
...
# pnpm
export PNPM_HOME="/home/shivam_sourav/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
